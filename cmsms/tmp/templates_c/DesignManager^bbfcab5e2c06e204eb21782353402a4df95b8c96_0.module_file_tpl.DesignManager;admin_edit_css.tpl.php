<?php
/* Smarty version 3.1.31, created on 2025-03-08 10:18:43
  from "module_file_tpl:DesignManager;admin_edit_css.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_67cc0b73b3d810_93426870',
...
function content_67cc0b73b3d810_93426870 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_function_form_start')) require_once 'C:\\xampp\\htdocs\\AplikacjeSieciowe\\cmsms\\lib\\plugins\\function.form_start.php';
if (!is_callable('smarty_function_cms_help')) require_once 'C:\\xampp\\htdocs\\AplikacjeSieciowe\\cmsms\\admin\\plugins\\function.cms_help.php';
...
if (!is_callable('smarty_function_tab_header')) require_once 'C:\\xampp\\htdocs\\AplikacjeSieciowe\\cmsms\\admin\\plugins\\function.tab_header.php';
if (!is_callable('smarty_function_tab_start')) require_once 'C:\\xampp\\htdocs\\AplikacjeSieciowe\\cmsms\\admin\\plugins\\function.tab_start.php';
if (!is_callable('smarty_function_cms_textarea')) require_once 'C:\\xampp\\htdocs\\AplikacjeSieciowe\\cmsms\\lib\\plugins\\function.cms_textarea.php';
if (!is_callable('smarty_function_html_options')) require_once 'C:\\xampp\\htdocs\\AplikacjeSieciowe\\cmsms\\lib\\smarty\\plugins\\function.html_options.php';
if (!is_callable('smarty_function_tab_end')) require_once 'C:\\xampp\\htdocs\\AplikacjeSieciowe\\cmsms\\admin\\plugins\\function.tab_end.php';
if (!is_callable('smarty_function_form_end')) require_once 'C:\\xampp\\htdocs\\AplikacjeSieciowe\\cmsms\\lib\\plugins\\function.form_end.php';
echo '<script'; ?>
 type="text/javascript">
$(document).ready(function(){
    var do_locking = <?php if ($_smarty_tpl->tpl_vars['css_id']->value > 0 && isset($_smarty_tpl->tpl_vars['lock_timeout']->value) && $_smarty_tpl->tpl_vars['lock_timeout']->value > 0) {?>1<?php } else { ?>0<?php }?>;
    ...
    if( do_locking ) {
      $('#form_editcss').lockManager({
        type: 'stylesheet',
        oid: <?php echo $_smarty_tpl->tpl_vars['css_id']->value;?>
,
...
:</label>&nbsp;<?php echo smarty_function_cms_help(array('key2'=>'help_stylesheet_created','title'=>$_smarty_tpl->tpl_vars['mod']->value->Lang('prompt_created')),$_smarty_tpl);?>
            ...
            <p class="pageinput">
                <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['css']->value->get_created(),'%x %X');?>
...
:</label>&nbsp;<?php echo smarty_function_cms_help(array('key2'=>'help_stylesheet_modified','title'=>$_smarty_tpl->tpl_vars['mod']->value->Lang('prompt_modified')),$_smarty_tpl);?>
            ...
            <p class="pageinput">
                <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['css']->value->get_modified(),'%x %X');?>
